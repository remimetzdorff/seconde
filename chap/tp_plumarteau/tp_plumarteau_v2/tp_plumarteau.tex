...
De la même façon, expliquer à quoi correspondent les valeurs de \texttt{y}, \texttt{vx} et \texttt{vy} des lignes 22, 24 et 25.
Justifier.

\item \rea{} \val{}

En vous aidant de la question~\ref{quest:carac_vitesse} et des questions précédentes, modifier le programme pour représenter le vecteur vitesse $\vec{v_5}$.
\end{enumerate}
